...
import LocalityNetwork from '../../hero/LocalityNetwork';
import { supabase } from '../../../services/supabase/client';
import Segment1Home from '../segment1/Segment1Home';

/* ═══════════════════════════════════════════════════════════════════════
   HomeCoreSection
   ---------------------------------------------------------------------
   This is the pre-existing Home page body (Hero/Segment1 → Network card →
   Ride Hub → Live Updates → Deals → Events → Buzz → Businesses →
   Communities), moved verbatim out of pages/Home.jsx so it can be
   registered as a section inside the new config-driven HOME_SECTIONS /
   HomeSectionRenderer architecture.

   NOTHING in this file was redesigned, restyled, or behaviourally
   changed during the move — it is a pure extraction so Home.jsx can
   become a thin renderer. Treat this as the "core" section with a fixed
   early position in the section order until it is broken apart further.
═══════════════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════
   HOME CORE SECTION
═══════════════════════════════════════════════ */
export default function HomeCoreSection({ onNavigate }) {
