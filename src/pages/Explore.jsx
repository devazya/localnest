    ...
    */
    <div style={{
      ...
      {/*
        ...
        Margins from every edge: 14px left, 14px bottom.
        Max-width capped so it never covers centre.
        Uses glassmorphism: white/88 + blur.
        Intentionally placed — not pasted on.
      */}
      <div style={{
        position: 'absolute',
        bottom: 14,
        ...
        <div style={{ fontSize: 10, color: C.textMuted, marginBottom: 12, fontWeight: 500 }}>
          within 3 km
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 7, marginBottom: 14 }}>
          {MAP_STATS.map((s, i) => (
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
              ...
              <span style={{ fontSize: 11, color: C.textSub, fontWeight: 500, lineHeight: 1 }}>{s.label}</span>
            </div>
          ))}
        </div>
        ...
        <motion.button
          ...
          style={{
            ...
            cursor: 'pointer',
            letterSpacing: 0.1,
            boxShadow: '0 4px 16px rgba(109,74,255,0.42)',
          }}
        >
          View Full Map
